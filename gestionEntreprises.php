            ...
            <div class="card-body">
                <form action="#" method="POST" class="form-inline">
                    <div class="form-group">
                        <label for="inlineFormInput" class="sr-only">Rechercher entreprise</label>
                        <input id="inlineFormInput" type="text" name="rechercheEntreprise" placeholder="Rechercher entreprise"
